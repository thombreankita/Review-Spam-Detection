...
score = logreg.score(X, data["Deceptive"])
recall = metrics.recall_score(data["Deceptive"], logreg.predict(X))
precision = metrics.precision_score(data["Deceptive"], logreg.predict(X))
