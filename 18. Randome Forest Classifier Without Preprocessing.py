...
score = randomF.score(X, data["Deceptive"])
recall = metrics.recall_score(data["Deceptive"], randomF.predict(X))
precision = metrics.precision_score(data["Deceptive"], randomF.predict(X))
